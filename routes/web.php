...
// shared
Route::get('/sharing/{id}','ShareController@shared')->name('shared.shared');
...
Route::get('/login/google', 'DriveController@redirectToGoogleProvider');

Route::get('login/google/callback', 'DriveController@handleProviderGoogleCallback');